...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.history = QtWidgets.QTextBrowser(self.verticalLayoutWidget)
        self.history.setStyleSheet("border: 1px solid silver;")
        self.history.setObjectName("history")
        self.verticalLayout_2.addWidget(self.history)
        self.manualInput = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.manualInput.setStyleSheet("border: 1px solid silver;")
        self.manualInput.setObjectName("manualInput")
        self.verticalLayout_2.addWidget(self.manualInput)
